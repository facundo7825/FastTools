    ...
    <div className="flex flex-col gap-5">
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="flex flex-col gap-1.5 flex-1">
          <label htmlFor={pesoId} className="text-sm text-muted">
            Peso (kg)
          </label>
          <input
            id={pesoId}
        ...
        <div className="flex flex-col gap-1.5 flex-1">
          <label htmlFor={alturaId} className="text-sm text-muted">
            Altura (cm)
          </label>
          <input
            id={alturaId}
      ...
      <div className="border border-border rounded-xl p-4 bg-background">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-1 text-xs text-muted">
          ...
          <span className="text-orange-500 font-medium">30 - 34.9</span>
          <span>Obesidad II</span>
          <span className="text-red-500 font-medium">35 - 39.9</span>
          <span>Obesidad III</span>
          <span className="text-red-700 font-medium">&gt;= 40</span>
        </div>
      </div>
    </div>
  );
