...
const featuredTools = [
  {
    ...
    description: "Para textos largos, entregas, notas y borradores.",
    badge: "Popular",
  },
  {
    href: "/generadores/qr",
    title: "Generador de QR",
    description: "Crea, descarga y copia codigos QR en segundos.",
    badge: "Practica",
  },
  {
    href: "/calculadoras/porcentaje",
    title: "Calculadora de porcentaje",
    description: "Descuentos, IVA, aumentos y calculos simples.",
    badge: "Rapida",
  },
];
...
const categories = [
  {
    ...
    description: "Herramientas para contar, limpiar, convertir y ajustar contenido escrito.",
    tools: [
  ...
  },
  {
    ...
    description: "Para producir contrasenas, codigos QR y contenido de apoyo en segundos.",
    tools: [
  ...
  },
  {
    ...
    description: "Para cuentas utiles del dia a dia sin abrir planillas ni apps extra.",
    tools: [
  ...
  return (
    <div className="flex flex-col gap-8 sm:gap-12">
      ...
      <section className="rounded-[2rem] border border-border bg-surface px-6 py-7 shadow-sm sm:px-8 sm:py-9">
        ...
        <h1 className="mt-3 text-3xl sm:text-5xl font-extrabold text-text">
          Todas las herramientas en un solo panel
        </h1>
        <p className="mt-4 max-w-3xl text-muted">
          FastTools organiza las utilidades por tipo de tarea para que encuentres rapido lo
          que necesitas: escribir mejor, generar recursos o resolver calculos.
        </p>
      </section>
      ...
      <section className="rounded-[1.8rem] border border-border bg-surface px-5 py-6 shadow-sm sm:px-7">
        <div className="mb-5">
          ...
          <h2 className="mt-2 text-2xl sm:text-3xl font-bold text-text">
            Herramientas que suelen resolver mas rapido
          </h2>
        </div>
