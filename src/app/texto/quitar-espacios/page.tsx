  ...
  "@graph": [
    {
      ...
      step: [
        ...
        { "@type": "HowToStep", text: "El resultado limpio aparece automáticamente." },
    ...
    },
    {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "¿Qué espacios elimina la herramienta?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Sí. Es útil para normalizar texto que llega con saltos o espacios irregulares.",
          },
        },
        {
          "@type": "Question",
          name: "¿Se pierden acentos o símbolos?",
          acceptedAnswer: {
            "@type": "Answer",
...
const content = (
  <>
    ...
    <p>
      Sí. Es especialmente útil cuando el texto llega con formato roto o con separaciones
      irregulares.
    </p>
    <h3>¿Se pierden acentos o símbolos?</h3>
    <p>
